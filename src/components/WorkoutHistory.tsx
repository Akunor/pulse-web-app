...
import { Dumbbell, Clock, FileWarning as Running, SwissFranc as Swim, Bike, Plus, X, Trash2 } from 'lucide-react';
...
export function WorkoutHistory() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-6">Workout History</h2>
