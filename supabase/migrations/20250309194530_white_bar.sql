/*
  # Update notification system with web app link

  1. Changes
    - Add web app URL to notification payload
    - Update notification templates to include direct links
*/

-- Update the notification functions to include web app URL
...
DECLARE
    ...
    webapp_url TEXT;
BEGIN
    -- Get web app URL from database settings
    webapp_url := current_setting('app.webapp_url');
...
-- Update the test function to include web app URL
